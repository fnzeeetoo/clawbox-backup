// Fixed: Pass a proper callback function instead of an object in executeSchedule
...
export class Scheduler {
  ...
  async executeSchedule(schedule) {
    try {
      ...
      // FIXED: Pass a proper callback function
      await this.engine.runBackup(source, destination, schedule.backupType, (event) => {
        console.log(`[Schedule: ${schedule.name}] ${event.message}`);
      });
